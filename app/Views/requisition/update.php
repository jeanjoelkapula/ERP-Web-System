...
<script>
    ...
    function disableInput() {
        $("#form-requisition :input").prop("disabled", true);
        Swal.fire('Error!','This requisition has either been approved, declined, or completed and cannot be modified','error');
    }

    <?php
        if ($approved || $declined || $complete) {
    ?>
        disableInput();
    <?php
        }
