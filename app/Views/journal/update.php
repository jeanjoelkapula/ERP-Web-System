			...
			<div class="layout-content">
				...
				<div class="container-fluid flex-grow-1 container-p-y" id="outer_wrapper">
					<h4 class="font-weight-bold py-3 mb-4">
						<span class="text-muted font-weight-light"> Journal /</span> Update
					</h4>
...
var stockItems = [];
	...
	function updateTotal(e,ebq) {
        ...
        var foundItem = stockItems.find(item=>item.EBQ_CODE == ebq);
        console.log('item',foundItem)
        
		var quantity_difference = parseInt(e.value) - foundItem.QUANTITY;
		totalText.text(formatter.format(foundItem.AVG_COST*quantity_difference));
		input.val(foundItem.AVG_COST*quantity_difference);
	}
...
$(document).ready(function() {
    ...
    $("#stock-quantity").on('change',function(){ 
            updateTotal(this,'<?php if(isset($ebq_code))echo $ebq_code; ?>')
        })	
