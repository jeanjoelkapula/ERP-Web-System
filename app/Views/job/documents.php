	...
	<div class="layout-content">
		...
		<div class="container-fluid flex-grow-1 container-p-y">
			<h4 class="font-weight-bold py-3 mb-4">
				<span class="text-muted font-weight-light">Job /</span> Documents
			</h4>
			<br/>             
			<div class="card">
				<div class="container-fluid flex-grow-1 container-p-y">
					<div class="container-m-nx container-m-ny bg-lightest mb-3">
						<ol class="breadcrumb text-big container-p-x py-3 m-0">
                            ...
                            ?>
                                <li class="breadcrumb-item">
                                    <a href="javascript:void(0)"><?php echo $info['JOB_ID']; echo " - "; echo $info['ORDER_NO']; echo " - "; 
						...
						<div class="file-manager-actions container-p-x py-2">
							<div>
								<a class="btn btn-primary mr-2" href="/job/upload?job=<?php foreach($job_info as $info) {echo $info['JOB_ID'];} ?>"><span style="color:white;" ><i class="ion ion-md-cloud-upload" ></i>&nbsp; Upload</span></a>
					...
					<div class="file-manager-container file-manager-col-view">
						...
						?>
						<form id ="form-data" action="/job/documents/dl" method="post" style="display:none">
							<input id="job-input" type="text" name="job" value="<?php echo $job; ?>" hidden />
						</form>
						<form id ="form-remove" action="/job/documents/del" method="post" style="display:none">
						</form>
					</div>
				</div>
			</div>
