...
<div class="layout-wrapper layout-2">
	<div class="layout-inner">
		...
		<div class="layout-container">
            ...
            <form id="frm_create_voc" autocomplete="off" method="POST" action="/voc/create" novalidate="novalidate" class="sw-main sw-theme-default">
                <input type="hidden" name="frm_create_voc" value="true"></input>
				<!-- Content -->
                ...
                <div class="mb-3">
                    ...
                    <div id="smartwizard-2-step-1" class="card animated fadeIn">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <select class="custom-select btn-block select2" name="order_no" id="order_no">
                                        <?php 
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-outline-primary float-right mt-5">Create</button>
